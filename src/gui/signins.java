 ...
 * @author James
 */
public class signins extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(signins.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
